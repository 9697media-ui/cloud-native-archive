              ...
              return (
                ...
                >
                  ...
                  <div
                    ...
                    onDragEnd={handleDragEnd}
                    onDrop={handleDrop}
                    className={`flex-1 flex items-center justify-center cursor-grab active:cursor-grabbing h-full w-full overflow-hidden rounded-xl bg-white shadow-sm group-hover/module:shadow-md transition-shadow p-6`}
                  >
